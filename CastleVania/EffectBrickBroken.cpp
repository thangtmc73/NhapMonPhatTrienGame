...
CEffectBrickBroken::CEffectBrickBroken(int a_x, int a_y) : CEffect()
{
	_startPoint.x = a_x;
	_startPoint.y = a_y;
...
CEffectBrickBroken::~CEffectBrickBroken()
{
...
void CEffectBrickBroken::update(int a_deltaTime)
{
	bool tempt;
...
void CEffectBrickBroken::drawWithCamera(GCamera * a_camera)
{
	if (a_camera == NULL)
	{
		return;
